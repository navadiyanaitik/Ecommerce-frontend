...
import { getAllProducts } from "./actionCreator";
  ...
  return (
    <Layout>
      <section className="container">
        {/* <h1 className='text-2xl sm:text-3xl md:text-4xl text-center font-medium !my-8' id='products'>Products</h1> */}
        <div className="flex justify-start mb-5">
                ...
                {categories.map((item, index) => {
                  return (
                    <div className="flex items-center mb-4" key={index}>
                      ...
                      <span className="ml-2 text-sm capitalize select-none">
                        {item}
                      </span>
                    </div>
                  );
            ...
            <div className="mb-8">
              ...
              <div className="flex items-center ml-3">
                <Rating
                  ...
                  disableFillHover
                />
                <button className="ml-5 bg-white border text-primary font-medium rounded-md px-2 py-0.5 border-primary">
                  Go
                </button>
              </div>
            </div>
          ...
          <div
            className={`bg-black bg-opacity-20 fixed inset-0 transition-all duration-150 ease-in z-20 ${
          ...
          <div className={`flex-grow w-full sm:w-auto p-5 sm:p-8`}>
            <div className="flex items-center mb-10 lg:hidden">
              <span
                className="mx-2.5 grid place-items-center bg-primary w-8 h-8 sm:w-10 sm:h-10 rounded-full"
                onClick={() => {
              ...
              <div className="flex-grow ps-3">
                <h1 className="sm:text-center text-2xl font-semibold">
                  Products
                </h1>
              </div>
            </div>
