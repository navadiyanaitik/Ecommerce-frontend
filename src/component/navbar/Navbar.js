                    ...
                    <div className='nav-wrapper flex items-center justify-between p-1.5 h-full'>
                        ...
                        <div className='nav-items hidden md:block '>
                            <ul className='m-0 p-0 flex items-center'>
                                <li>
                                    <Link to={'/'} className={`page-link ${path === '/' ? 'text-primary text-opacity-100' : 'text-black'} cursor-pointer relative  text-opacity-70 font-medium no-underline mx-2.5 hover:text-primary`}>Home</Link>
                                </li>
                                <li>
                                    <Link to={'/admin/dashboard'} className={`page-link ${path === '/dashboard' ? 'text-primary text-opacity-100' : 'text-black'} cursor-pointer relative  text-opacity-70 font-medium no-underline mx-2.5 hover:text-primary`}>Dashboard</Link>
                                </li>
                                <li>
                        ...
                        <div className='hidden md:flex items-center'>
                            <Link to={'/login'} className='flex items-center cursor-pointer mr-2.5'>
